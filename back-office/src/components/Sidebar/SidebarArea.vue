<template>
  <aside
    class="absolute left-0 top-0 z-999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-dark text-white duration-300 ease-linear lg:static lg:translate-x-0"
    :class="{
