    ...
    <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1">
        <div class="flex flex-grow items-center justify-between lg:justify-end py-4 px-4 shadow-2 md:px-6 2xl:px-11">
            <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
                <router-link class="block flex-shrink-0 text-4xl lg:hidden" to="/">
                    💈
                </router-link>
                <!-- Hamburger Toggle BTN -->
                <button class="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm lg:hidden" @click="() => {
                    ...
                    <span class="relative block h-5.5 w-5.5 cursor-pointer">
                        ...
                        <span class="block absolute right-0 h-full w-full rotate-45">
                            ...
                            <span
                                ...
                                :class="{ '!h-0 delay-200': !isSidebarOpen }"></span>
                        </span>
                    </span>
                </button>
                <!-- Hamburger Toggle BTN -->
