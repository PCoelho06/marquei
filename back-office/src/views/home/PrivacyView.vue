<template>
    <div class="flex flex-col items-center justify-center h-full">
        <h1 class="text-4xl font-bold">Política de Privacidade</h1>
        <p class="mt-4 text-center">
            A sua privacidade é importante para nós. É política do Coelho Chat respeitar a sua privacidade em relação a
            qualquer informação sua que possamos coletar no site Coelho Chat, e outros sites que possuímos e operamos.
        </p>
        <p class="mt-4 text-center">
