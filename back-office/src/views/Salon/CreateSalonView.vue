    ...
    <DefaultLayout>
        <div class="container mx-auto">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-2xl font-semibold">Registar o salão</h1>
                    ...
                    <form @submit.prevent="createSalon">
                        <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2">
                            ...
                            <InputGroup id="country" autocomplete="country-name" label="Pais" type="text"
                                placeholder="Entre o nome do pais" v-model="salon.country"
                                :error="validationErrors.country" :required=true :disabled=true>
